<?php
/**
 * @name filtreRessource.class.php Service de filtrage des ressources documentaires
...
class filtreRessource implements \wp\Ajax\ajax{
	...
	**/
	...
	public function process(){
		...
		$this->ressource->searchBy($searchCols,$searchValue);
		
		if($this->ressource->count() > 0){
			$this->ressource->set($this->ressource->getNameSpace());
			...
			foreach($this->ressource->getCollection() as $ressource){
