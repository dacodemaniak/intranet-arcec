<?php
/**
 * @name typeParam.class.php : Gestion des types de paramètres
...
class typeParam extends \wp\formManager\admin{
	...
	public function __construct(){
		...
		$this->mapper = new \arcec\Mapper\typetableparamMapper();
		...
		\wp\Tpl\templateEngine::getEngine()->setVar("indexTitle","Types de paramètres");
