 ...
 * @package formManager
 * @version 1.1
 * @update Ajout du calcul du nombre total de document associé à une branche
 * 	ajout de l'icône pour supprimer une branche vide.
 **/
namespace arcec;
	...
	public function __construct(){
		...
		if(is_null(\wp\Helpers\urlHelper::context())){
			...
			$this->index->setHeaders(array(
				...
				->childrenMapper(new \arcec\Mapper\docporteurMapper())
				->module($this->module)
				->process()
			;
