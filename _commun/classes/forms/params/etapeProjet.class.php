<?php
/**
 * @name etapeProjet.class.php : Gestion des étapes de suivi de projet
...
class etapeProjet extends \wp\formManager\admin{
	...
	public function __construct(){
		...
		$this->mapper = new \arcec\Mapper\etapeprojetMapper();
		...
		\wp\Tpl\templateEngine::getEngine()->setVar("indexTitle","Etape de suivi des projets");
