<?php
/**
 * @name defArboAnnuaire.class.php : Gestion de l'arborescence de l'annuaire général
...
class defArboAnnuaire extends \wp\formManager\admin{
	...
	public function __construct(){
		...
		$this->mapper = new \arcec\Mapper\arboannuaireMapper();
		...
		\wp\Tpl\templateEngine::getEngine()->setVar("indexTitle","Annuaire - Classement");
	...
	protected function set(){
		...
		// Noeud pour des adresses internes ou externes
		$field = new \wp\formManager\Fields\checkbox();
		$field->setId("frmInterne")
		->setName($this->mapper->getTableName() . "." . $this->mapper->getColumnPrefix() . "interne")
		->setLabel("Entrées internes")
		->setCss("control-label",true)
		->setCss("col-sm-12",true)
		->setCss("form-control")
		->setValue($this->mapper->getObject()->interne);
