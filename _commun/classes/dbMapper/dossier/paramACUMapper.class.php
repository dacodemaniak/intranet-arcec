<?php
/**
 * @name paramACUMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent ACU ou id 32
...
class paramACUMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		$this->usage();
		//$this->searchBy("param_definition_id",32); // Restreint la liste aux paramètres de base
