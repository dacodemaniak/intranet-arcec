<?php
/**
 * @name paramSCPMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent SCP (Secteurs Professionnels)
...
class paramSCPMapper extends \arcec\Mapper\parambaseMapper {
