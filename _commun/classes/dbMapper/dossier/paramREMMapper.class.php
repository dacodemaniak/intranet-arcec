<?php
/**
 * @name paramREMMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent REM (Rémunérations)
...
class paramREMMapper extends \arcec\Mapper\parambaseMapper {
