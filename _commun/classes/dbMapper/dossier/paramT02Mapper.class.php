<?php
/**
 * @name paramT02Mapper.class.php Mapping de données sur la table dbprefix_paramcomment avec le code Parent T02
...
class paramT02Mapper extends \arcec\Mapper\paramcommentMapper {
