<?php
/**
 * @name paramSTSMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent STS (Statuts Sociaux)
...
class paramSTSMapper extends \arcec\Mapper\parambaseMapper {
