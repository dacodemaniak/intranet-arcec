<?php
/**
 * @name paramDPLMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent DPL ou id 3
...
class paramDPLMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",3); // Restreint la liste aux paramètres de base
