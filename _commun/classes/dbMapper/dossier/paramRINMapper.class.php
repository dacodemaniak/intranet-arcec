<?php
/**
 * @name paramRINMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent RIN ou id 39
...
class paramRINMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",24); // Restreint la liste aux paramètres de base
