<?php
/**
 * @name paramPRGMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent PRG (Programmes)
...
class paramPRGMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",8); // Restreint la liste aux paramètres de base
