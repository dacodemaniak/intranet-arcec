<?php
/**
 * @name paramETDMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent ETD ou id 7
...
class paramETDMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",7); // Restreint la liste aux paramètres de base
