<?php
/**
 * @name paramVOIMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent VOI ou id 23
...
class paramVOIMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",23); // Restreint la liste aux paramètres de base
