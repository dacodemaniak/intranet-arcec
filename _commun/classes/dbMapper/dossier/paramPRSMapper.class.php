<?php
/**
 * @name paramETUMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent PRS ou id 8
...
class paramPRSMapper extends \arcec\Mapper\parambaseMapper {
