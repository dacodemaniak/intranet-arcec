<?php
/**
 * @name paramT01Mapper.class.php Mapping de données sur la table dbprefix_paramcomment avec le code Parent T01 ou id 45
...
class paramT01Mapper extends \arcec\Mapper\paramcommentMapper {
