<?php
/**
 * @name paramSITMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent SIF ou id 38
...
class paramSIFMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",38); // Restreint la liste aux paramètres de base
