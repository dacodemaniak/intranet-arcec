<?php
/**
 * @name paramOPFMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent OPF (Options Fiscales)
...
class paramOPFMapper extends \arcec\Mapper\parambaseMapper {
