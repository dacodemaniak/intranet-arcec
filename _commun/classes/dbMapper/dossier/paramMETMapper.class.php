<?php
/**
 * @name paramMETMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent MET (Répertoires des métiers)
...
class paramMETMapper extends \arcec\Mapper\parambaseMapper {
