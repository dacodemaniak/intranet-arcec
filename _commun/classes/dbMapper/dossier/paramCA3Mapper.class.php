<?php
/**
 * @name paramCA3Mapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent CA3 Projet non viable
...
class paramCA3Mapper extends \arcec\Mapper\parambaseMapper {
