<?php
/**
 * @name paramEDOMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent EDO ou id 15
...
class paramEDOMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",15); // Restreint la liste aux paramètres de base
