<?php
/**
 * @name paramCNTMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent CNT ou id 25
...
class paramCNTMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",25); // Restreint la liste aux paramètres de base
