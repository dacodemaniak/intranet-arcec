<?php
/**
 * @name arbofichierMapper.class.php : Mapping de la table prefix_arbofichier
...
class arbofichierMapper extends \wp\dbManager\dbMapper {
	/**
	...
	**/
	...
	public function __construct(){
		...
		$this->columnPrefix = "arbofichier_";
