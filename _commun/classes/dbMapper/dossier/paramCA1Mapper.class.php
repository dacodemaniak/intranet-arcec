<?php
/**
 * @name paramCA1Mapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent CA1 ou id 45
...
class paramCA1Mapper extends \arcec\Mapper\parambaseMapper {
