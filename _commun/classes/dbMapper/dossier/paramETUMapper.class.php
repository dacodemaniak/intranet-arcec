<?php
/**
 * @name paramETUMapper.class.php Mapping de données sur la table dbPrefix_parambase avec le code Parent ETU ou id 1
...
class paramETUMapper extends \arcec\Mapper\parambaseMapper {
	public function __construct(){
		...
		//$this->searchBy("param_definition_id",1); // Restreint la liste aux paramètres de base
