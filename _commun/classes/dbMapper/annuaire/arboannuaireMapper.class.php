<?php
/**
 * @name arboannuaireMapper.class.php : Mapping de la table prefix_arboannuaire
...
class arboannuaireMapper extends \wp\dbManager\dbMapper {
	/**
	...
	**/
	...
	public function __construct(){
		...
		$this->columnPrefix = "arboannuaire_";
	...
	protected function defineScheme(){
		$this->scheme = array(
			...
			"interne" => array("type" => "smallint","default" => 0),
